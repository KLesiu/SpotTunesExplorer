...
@Component({
    ...
    <section class="w-[100%] h-[100%] flex flex-wrap justify-center content-around" >
        ...
        <a class="w-[60%] h-[30%] flex flex-wrap justify-center content-around bg-gray-300 text-4xl text-center rounded-xl hover:bg-gray-200" [href]="AUTH_URL">Login With Spotify</a>
    </section>
    `,
})
